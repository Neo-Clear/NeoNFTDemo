...
var langs = {
    cn: {
        ...
        div_recharge_type: "type(zoro: gas/neo/bct/bcp/btc/eth；NEO: gas/neo/cgas/cneo)：",
        div_recharge_count: "count（充值金额）:",
        div_recharge_extString: "extString（透传参数）:",
        div_recharge_do: "充值",

        div_confirm_txid: "txid（链上交易ID）:",
        div_confirm_do: "确认",

        div_transfer_type: "type(zoro: gas/neo/bct/bcp/btc/eth；NEO: gas/neo/cgas/cneo)：",
    ...
    en: {
        ...
        sdk_init: "Init",
        sdk_initex: "InitEx",
        sdk_lock_chain: "LockChain",
        sdk_lock_net: "LockNet",

        title_base: "Basic",
        sdk_login: "Login",
        sdk_uinfo: "UserInfo",
        sdk_chain_type: "ChainType",
        ...
        title_pay: "Recharge/Transfer",
        sdk_recharge: "Recharge",
        ...
        div_recharge_type: "type(zoro: gas/neo/bct/bcp/btc/eth; NEO: gas/neo/cgas/cneo):",
        div_recharge_count: "count(Recharge amount):",
        div_recharge_extString: "extString(Transmission parameters):",
        div_recharge_do: "MakeRecharge",
